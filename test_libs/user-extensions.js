 ...
 *
 *      The callFlexMethod function and the associated dependent functions in this file are from The SeleniumFlex-API (sfapi.googlecode.com)
 *      
 ...
 */
 ...
 /** 
  * user-extensions.js adds FlexMonkeyCommand and FlexMonkeyVierfy command extensions to Selenium Core
  */


// JUSTIN STOLE THIS FROM: http://code.google.com/p/flash-selenium/issues/detail?id=38, comment #1
...
Selenium.prototype.callFlexMethod = function (method, id, args) {
	try {
		...
		// Stu commented this out because it was always hitting the "return false" line
//		if (flashObj['doFlexClick'] == null) {
